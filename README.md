...
<img src="https://skillicons.dev/icons?i=python,c,java,ai,tensorflow,pytorch,sklearn,opencv,bitbucket,mysql,mongo,md,html,css,js,docker,nodejs,fastapi,flask,aws,gcp,firebase,jenkins,git,github,postman,anaconda,vscode,discord,bash,linux,windows&perline=8" />
